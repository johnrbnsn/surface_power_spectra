# Source: https://github.com/keflavich/image_tools/blob/master/image_tools/radialprofile.py
# NOTE: No license was included, but according to GitHub rules, public repos can be copied and used, see:
